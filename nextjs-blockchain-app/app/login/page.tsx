...
import FancyButton from "@/components/Stylebutton";
...
export default function Login() {
  ...
  animate={{
    y: ["0%", "20%", "-20%", "0%"], // Moves up and down
    x: ["0%", "10%", "-10%", "0%"], // Moves side-to-side
  }}
  transition={{
    duration: 3.5, // Time for one cycle
    repeat: Infinity, // Loop forever
    ease: "easeInOut", // Smooth motion
  }}
>
  <img src="/image/loginside.png" alt="Floating Image" className="w-full h-full" />
</motion.div>
...
>
        ...
        <h2 className="text-2xl font-bold text-center">Login to ShippyChain</h2>
...
<motion.div className="relative mt-6">
  ...
  />
        ...
        {/* Submit Button */}
        {/* <motion.button
          className="w-full mt-6 py-3 rounded-lg text-lg font-semibold bg-transparent border border-purple-500 text-white hover:bg-purple-500 hover:text-black transition duration-300"
        ...
        <div className="w-full flex justify-center mt-4">
                <Link href="/register" className="text-sm text-gray-400 hover:text-white transition duration-300">
